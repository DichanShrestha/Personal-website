  ...
  return (
    <section className="z-10 flex w-full flex-col items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center pt-20 md:pb-16 lg:pb-32">
      ...
      >
        ...
        <AnimatedTitle
          wordSpace={"mr-[0.15em]"}
          charSpace={"mr-[0.005em]"}
          text={"Blog"}
          className={`flex max-w-[500px] flex-col items-start pr-5 text-left font-serif  text-[clamp(70px,10vw,155.04px)] font-extrabold uppercase leading-[0.9em] text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center lg:text-center`}
        />
        <AnimatedBody
