...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="relative z-10 flex h-[550px] w-full items-center justify-center overflow-hidden rounded-3xl bg-center py-0 sm:h-[700px] md:h-[650px] lg:h-[500px]"
      initial="initial"
      animate="animate"
    >
      <Image
        src={image}
        alt={name}
        className={`absolute bottom-0 w-[70%] object-contain transition-all duration-500 sm:w-[85%] md:w-[60%] lg:max-w-[55%] ${
      ...
      >
        <AnimatedTitle
          text={name}
          className="text-[36px] leading-tight md:text-[44px] lg:text-[48px]"
          wordSpace="mr-[0.25em]"
          charSpace="-mr-[0.01em]"
        />
        <AnimatedBody
